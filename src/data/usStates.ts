...
/** All 50 US states with USPS codes and Census FIPS ids (matching us-atlas TopoJSON). */
...
export const usStatesByCode = new Map(usStates.map((s) => [s.code, s]))
export const usStatesByFips = new Map(usStates.map((s) => [s.fips, s]))
